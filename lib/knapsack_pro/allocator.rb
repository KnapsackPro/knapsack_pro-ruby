...
module KnapsackPro
  class Allocator
    ...
    def test_file_paths
      ...
      return try_initializing_split(test_files_result.tests) if test_files_result.tests_found_quickly?
      ...
      try_initializing_split(test_files_result.tests)
    end
    ...
    def try_initializing_split(tests)
