module KnapsackPro
  module Runners
    class RswagRunner < BaseRunner
      def self.run(args)
        require 'rspec/core'

        ENV['KNAPSACK_PRO_TEST_SUITE_TOKEN'] = KnapsackPro::Config::Env.test_suite_token_rswag
        ENV['KNAPSACK_PRO_RECORDING_ENABLED'] = 'true'

        adapter_class = KnapsackPro::Adapters::RswagAdapter
        ...
        if runner.test_files_to_execute_exist?
          ...
          task_name = 'knapsack_pro:rswag_run'
          ...
          ::RSpec::Core::RakeTask.new(task_name) do |t|
            ...
            t.pattern = []
            t.rspec_opts = "#{args} --format Rswag::Specs::SwaggerFormatter --order defined --default-path #{runner.test_dir} #{runner.stringify_test_file_paths}"
